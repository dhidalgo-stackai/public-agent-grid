...
const ALL_APPS = [
  ...
  { id: "excel", label: "Excel", category: "Productivity" },
  { id: "word", label: "Word", category: "Productivity" },
  { id: "powerpoint", label: "PowerPoint", category: "Productivity" },
  { id: "onedrive", label: "OneDrive", category: "Storage" },
  { id: "sharepoint", label: "SharePoint", category: "Storage" },
  { id: "teams", label: "Microsoft Teams", category: "Communication" },
  { id: "sap", label: "SAP", category: "ERP" },
  { id: "oracle", label: "Oracle", category: "ERP" },
  { id: "netsuite", label: "NetSuite", category: "ERP" },
  { id: "servicenow", label: "ServiceNow", category: "IT Service" },
  { id: "workday", label: "Workday", category: "HR" },
  { id: "adp", label: "ADP", category: "HR" },
  { id: "concur", label: "SAP Concur", category: "Finance" },
  ...
  { id: "tableau", label: "Tableau", category: "Analytics" },
